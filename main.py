...
st.info(
    "선택한 영화의 관객 수가 날짜에 따라 어떻게 변하는지 알 수 있습니다. 관객이 가장 많았던 날과 흥행이 줄어드는 시기도 확인할 수 있습니다."
)
...
st.info(
    "관객 수가 많은 영화들도 흥행하는 시기와 관객이 감소하는 시기가 서로 다르다는 것을 알 수 있습니다. 영화마다 흥행 기간과 관객 변화의 모습이 다르게 나타납니다."
)
...
st.info(
    "1년 동안 가장 많은 관객을 모은 영화가 어떤 영화인지 비교할 수 있습니다. 또한 각 영화가 박스오피스 10위권에 얼마나 오래 있었는지도 알 수 있습니다."
)
...
"전체 기간 동안 관객을 많이 모은 영화들을 비교하면 어떤 영화가 가장 인기가 많았는지 알 수 있고, 영화마다 10위 안에 머문 기간도 비교할 수 있습니다."
)
...
st.info(
"월과 요일에 따라 영화 관객 수가 달라지는 것을 알 수 있습니다. 어떤 달과 어떤 요일에 영화관을 찾는 사람이 많은지 색의 진하기를 통해 쉽게 비교할 수 있습니다.
-같은 요일이라도 달에 따라 관객 수가 다르게 나타납니다.
-평일보다 주말에 관객 수가 많은 칸이 나타나는지 쉽게 확인할 수 있습니다.
-특정 달의 특정 요일에 색이 유난히 진하게 나타나는 경우가 있습니다.
-반대로 관객 수가 적어서 색이 연하게 나타나는 달과 요일도 있습니다.
-영화를 보는 사람은 어느 요일에 가장 많을까?”라는 질문에 그래프를 이용해 답할 수 있습니다."
)
