...
st.info(
    "선택한 영화의 날짜별 관객 수를 살펴보면서 영화가 개봉한 뒤 관객이 언제 많아지고 적어지는지 확인할 수 있습니다."
)
...
st.info(
    "관객 수가 많은 TOP 5 영화를 함께 비교해 보면서 영화마다 흥행이 시작되고 최고점에 도달하는 시기가 서로 다르다는 것을 알 수 있습니다."
)
...
st.info(
    "날짜별 TOP 10 영화의 관객 수를 합쳐서 살펴보면 영화관을 찾는 사람들이 많은 시기와 적은 시기를 쉽게 비교할 수 있습니다."
)
...
st.info(
"월별·요일별 관객 수를 비교해 보면 어느 달에 관객이 많았는지, 또 일주일 중 어떤 요일에 영화 관람객이 많이 몰렸는지 알 수 있습니다."
)
